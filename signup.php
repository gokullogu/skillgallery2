...
$consignup = new mysqli("localhost", "root", "", "auth_reg");
if ($consignup->connect_error) {
    die("connection failed : " . $consignup->connect_error);
} else {
    $stmtsignup = $consignup->prepare("insert into auth_table_sign(username,email,password)values(?,?,?);");

    $stmtsignup->bind_param("sss", $_POST['username'], $_POST['email'], $_POST['password']);
    $stmtsignup->execute();
...
<body style="background-color: ghostwhite;">
    <div class="container">
        <form class="was-validated">
            ...
            <div>
                <button class="btn btn-success mx-auto d-block" style="background-image: linear-gradient(to right,#fde50b,#15dcf7f6);">sign up</button>
            </div>
        </form>
    </div>
</body>
