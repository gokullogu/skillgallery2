    ...
    <div class="cont">
        <nav class="navbar navbar-expand-sm bg-pink navbar-dark sticky-top">
            ...
            <div class="collapse navbar-collapse" id="collapsy">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-linkm" href="prac2.php">home</a></li>
                    <li class="nav-item"><a class="nav-linkm" href="prac2.php">about us</a></li>
                    <li class="nav-item"><a class="nav-linkm" href="prac2.php">gallery</a></li>
